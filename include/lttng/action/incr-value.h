 ...
 */
LTTNG_EXPORT extern struct lttng_action *lttng_action_incr_value_create(void);

/*
 * Set the session name of an lttng_action object of type
 * LTTNG_ACTION_TYPE_INCREMENT_VALUE.
 */
LTTNG_EXPORT extern enum lttng_action_status lttng_action_incr_value_set_session_name(
 ...
 * LTTNG_ACTION_TYPE_INCREMENT_VALUE.
 */
LTTNG_EXPORT extern enum lttng_action_status lttng_action_incr_value_get_session_name(
 ...
 * LTTNG_ACTION_TYPE_INCREMENT_VALUE.
 */
LTTNG_EXPORT extern enum lttng_action_status lttng_action_incr_value_set_map_name(
 ...
 * LTTNG_ACTION_TYPE_INCREMENT_VALUE.
 */
LTTNG_EXPORT extern enum lttng_action_status lttng_action_incr_value_get_map_name(
