...
LTTNG_EXPORT extern struct lttng_map_key *lttng_map_key_create(void);

LTTNG_EXPORT extern enum lttng_map_key_status lttng_map_key_append_token_variable(struct lttng_map_key *key, enum lttng_map_key_token_variable_type var_type);

LTTNG_EXPORT extern enum lttng_map_key_status lttng_map_key_append_token_string(
		struct lttng_map_key *key, const char *string);

LTTNG_EXPORT extern void lttng_map_key_destroy(struct lttng_map_key *key);
