...
#ifndef LTTNG_EVENT_RULE_KERNEL_KRETPROBE_H
#define LTTNG_EVENT_RULE_KERNEL_KRETPROBE_H
...
/*
 * Create a newly allocated kernel kretprobe event rule.
 *
 ...
 */
extern struct lttng_event_rule *lttng_event_rule_kernel_kretprobe_create(
		const struct lttng_kernel_probe_location *location);

/*
 * Get the kernel probe location of a kernel kretprobe event rule.
 *
 ...
 * this call.
 */
extern enum lttng_event_rule_status lttng_event_rule_kernel_kretprobe_get_location(
		const struct lttng_event_rule *rule,
		const struct lttng_kernel_probe_location **location);

/*
 * Set the name of a kernel kretprobe event rule.
 *
 ...
 */
extern enum lttng_event_rule_status lttng_event_rule_kernel_kretprobe_set_event_name(
		struct lttng_event_rule *rule, const char *name);

/*
 * Get the name of a kernel kretprobe event rule.
 *
 ...
 */
extern enum lttng_event_rule_status lttng_event_rule_kernel_kretprobe_get_event_name(
...
#endif /* LTTNG_EVENT_RULE_KERNEL_KRETPROBE_H */
