 ...
 *
 */
LTTNG_EXPORT extern struct lttng_map_query *lttng_map_query_create(
...
LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_set_sum_by_cpu(
		struct lttng_map_query *query, bool sum_by_cpu);

LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_set_sum_by_pid(
		struct lttng_map_query *query, bool sum_by_pid);

LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_add_cpu(
		struct lttng_map_query *query, int cpu_id);

LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_add_uid(
		struct lttng_map_query *query, uid_t uid);

LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_add_pid(
		struct lttng_map_query *query, pid_t pid);

LTTNG_EXPORT extern enum lttng_map_query_status lttng_map_query_add_key_filter(
		struct lttng_map_query *query, const char *key_filter);

LTTNG_EXPORT extern void lttng_map_query_destroy(struct lttng_map_query *query);
