...
#define for_each_map_key_token_const(__map_key_element, __map_key_list) \
	for (unsigned int __map_key_idx = 0; \
			(__map_key_element = lttng_map_key_get_token_at_index(__map_key_list, __map_key_idx)); \
			__map_key_idx++)
