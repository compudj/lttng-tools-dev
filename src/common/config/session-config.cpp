...
const char * const config_element_bitness = "bitness";
const char * const config_element_boundary_policy = "boundary_policy";
const char * const config_element_coalesce_hits = "coalesce_hits";
const char * const config_element_dimensions = "dimensions";
const char * const config_element_dimension = "dimension";
const char * const config_element_dimension_size = "size";

const char * const config_boundary_policy_overflow = "OVERFLOW";
...
static int process_map_node(xmlNodePtr map_node, struct lttng_handle *handle)
{
	...
	if (!enabled) {
		ret = lttng_disable_map(handle, map);
		if (ret) {
			goto end;
		}
	}
